...
Current release: **v1.3.0-r15** (the table below tracks the current
...
|---|---|---|
| Redmi AX6S / MT7622 / AArch64 (cortex-a53) | `wificalling-location-gateway_1.3.0-r15_aarch64_cortex-a53.ipk` | `wificalling-location-gateway-lite_1.3.0-r15_aarch64_cortex-a53.ipk` |
| OpenWrt 24.10 / iStoreOS 24.10 / x86-64 | `wificalling-location-gateway_1.3.0-r15_x86_64.ipk` | `wificalling-location-gateway-lite_1.3.0-r15_x86_64.ipk` |
| OpenWrt 25.x / x86-64 (APK) | `wificalling-location-gateway-1.3.0-r15.apk` | `wificalling-location-gateway-lite-1.3.0-r15.apk` |
...
`wificalling-location-gateway-1.3.0-r15.apk` (or the `-lite-` variant), verify it
