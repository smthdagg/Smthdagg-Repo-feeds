...
|---|---|---|---|---|
| 2026-09-13 | wificalling-location-gateway | 1.3.0-r14 | IPv4/IPv6 coexistence fix: isolate WFC IPv6, route WLOC IPv6 CDN targets independently, and clean DNS sections on stop; standard + lite, x86_64 + aarch64 | ✅ feed-verify |
